        ...
        <div className='w-full mx-auto'>
           <div className='mx-auto'>
              ...
              <div className='flex justify-center py-10'>
                <button className='bg-white text-black shadow-2xl shadow-blue-800 px-20 py-4 rounded-full poppins-semibold cursor-pointer' onClick={() => { navigate('/signUp')}}>Get Started</button>
              </div>
           </div>
        </div>
