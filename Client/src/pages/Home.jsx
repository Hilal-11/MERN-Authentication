    ...
    <div>
      <div>
        ...
        <div className='flex justify-between py-6 px-10'>
          ...
          <div>
            {/* <button className='text-white shadow-2xl shadow-blue-800 px-12 py-3 rounded-full poppins-semibold ring-1 ring-amber-500 cursor-pointer' onClick={() => { navigate('/login')}}>Login</button> */}
